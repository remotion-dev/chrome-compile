...
# =============================================================================
# build-chromium-x86.sh — Build Chromium 144.0.7559.97 headless_shell (x86_64)
#
...
echo "========================================="
echo "Building Chromium $CHROME_VERSION headless_shell (Linux x86_64)"
echo "========================================="
...
# =============================================================================
# 9. Build Ninja from source (Ubuntu's version may be too old)
# =============================================================================
echo ">>> Step 9: Build and install Ninja"

# Ensure python command exists (Ubuntu 22.04 has python3 only)
...
cp /root/args-x86.gn /root/chromium/src/out/Headless/args.gn
...
GCC_DIR=$(find /usr/lib/gcc/x86_64-linux-gnu/ -maxdepth 1 -type d | tail -1)
...
cp out/Headless/headless_shell final/chrome-linux/
cp out/Headless/libEGL.so final/chrome-linux/
cp out/Headless/libGLESv2.so final/chrome-linux/
cp out/Headless/libvk_swiftshader.so final/chrome-linux/
cp out/Headless/libvulkan.so.1 final/chrome-linux/
cp out/Headless/vk_swiftshader_icd.json final/chrome-linux/

cd final
zip -r chromium-headless-shell-linux64.zip chrome-linux

echo ""
echo "========================================="
echo "BUILD COMPLETE!"
echo "Output: /root/chromium/src/final/chromium-headless-shell-linux64.zip"
echo "========================================="
echo ""
